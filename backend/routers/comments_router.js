...
//get for world
commentsRouter.get('/worldId=:worldId&page=:page&limit=:limit',async (req,res)=>{
    ...
    const comments = await Comments.find({worldId:worldId}).skip(page*limit).limit(limit+1);
